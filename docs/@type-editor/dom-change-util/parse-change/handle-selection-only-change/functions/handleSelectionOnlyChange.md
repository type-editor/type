...
Defined in: [parse-change/handle-selection-only-change.ts:29](https://github.com/type-editor/type/blob/29c0b7ebbb68b1528c0edc5e9973c4538cccdb64/packages/dom-change-util/src/dom-change/parse-change/handle-selection-only-change.ts#L29)
