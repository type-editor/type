...
Defined in: [input-handler/util/key-event.ts:14](https://github.com/type-editor/type/blob/1440286448396eb7a2fecaed8442b6ac57cafd0e/packages/input/src/input-handler/util/key-event.ts#L14)
