...
[Type Editor](../../index.md) / @type-editor/keymap
...
Bindings should map key names to command-style functions (see [@type-editor/commands](../commands/README.md)), which will be called with `(EditorState, dispatch, EditorView)` arguments and should return `true` when they've handled the key.
...
- [@type-editor/commands](../commands/README.md) - Command functions to use with keymaps
- [@type-editor/state](../state/README.md) - Editor state and plugin system
- [@type-editor/view](../view/README.md) - Editor view that processes key events
...
[baseKeyMap](baseKeyMap/README.md)
