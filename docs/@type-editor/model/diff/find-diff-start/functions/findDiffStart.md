...
Defined in: [packages/model/src/diff/find-diff-start.ts:46](https://github.com/type-editor/type/blob/99c78b8d1f93eef5c6a5bbfe09ed0a72a4c9ab4c/packages/model/src/diff/find-diff-start.ts#L46)
