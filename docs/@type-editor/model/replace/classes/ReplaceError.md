...
[Type Editor](../../../../index.md) / [@type-editor/model](../../README.md) / [replace](../README.md) / ReplaceError

# Class: ReplaceError

Defined in: [packages/model/src/replace.ts:29](https://github.com/type-editor/type/blob/4813813a587dda7eec62dd72332119887ded8d65/packages/model/src/replace.ts#L29)
...
```ts
new ReplaceError(message?): ReplaceError;
```
...
```ts
new ReplaceError(message?, options?): ReplaceError;
```
