...
Defined in: [commands/util/replace-command.ts:19](https://github.com/type-editor/type/blob/8f2401b36ac56cc1b338db1b9300f2d4f10eb04a/packages/search/src/commands/util/replace-command.ts#L19)
