...
Defined in: [commands/util/replace-command.ts:19](https://github.com/type-editor/type/blob/99c78b8d1f93eef5c6a5bbfe09ed0a72a4c9ab4c/packages/search/src/commands/util/replace-command.ts#L19)
