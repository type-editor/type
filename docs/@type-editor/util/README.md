...
[Type Editor](../../index.md) / @type-editor/util
...
[find-parent](find-parent/README.md)
...
[is-in-node-type](is-in-node-type/README.md)
...
[types/FindCallbackFunction](types/FindCallbackFunction/README.md)
...
[types/FindParentResult](types/FindParentResult/README.md)
