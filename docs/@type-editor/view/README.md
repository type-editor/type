...
[Type Editor](../../index.md) / @type-editor/view
...
<link
  rel="stylesheet"
  href="node_modules/@type-editor/view/style/prosemirror.css"
/>
```
...
const plugin = new Plugin({
  props: {
    decorations(state) {
      ...
      decos.push(
        Decoration.node(0, state.doc.content.size, { class: "document" }),
      );
...
[dom-observer/DOMObserver](dom-observer/DOMObserver/README.md)
...
[dom-observer/safari-shadow-selection-range](dom-observer/safari-shadow-selection-range/README.md)
...
[dom-observer/SelectionState](dom-observer/SelectionState/README.md)
...
[EditorView](EditorView/README.md)
...
[util/find-composition-node](util/find-composition-node/README.md)
