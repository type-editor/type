import type { Attrs } from '@type-editor-compat/model';
...
export function openPrompt(options: {
    ...
    const domFields: Array<HTMLElement> = [];
...
function getValues(fields: Record<string, Field>, domFields: ReadonlyArray<HTMLElement>) {
...
export class SelectField extends Field {
    render() {
        ...
        ;((this.options as any).options as Array<{ value: string, label: string }>).forEach(o => {
