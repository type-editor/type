...
import { Fragment, type Node, NodeRange, type NodeType, type ResolvedPos, Slice } from '@type-editor-compat/model';
import { type EditorState, type Transaction } from '@type-editor-compat/state';
import { canJoin, liftTarget, ReplaceAroundStep } from '@type-editor-compat/transform';
 ...
 */
function liftOutOfList(state: EditorState,
                       dispatch: (tr: Transaction) => void,
 ...
 */
function mergeListItems(transaction: Transaction,
                        list: Node,
                        startIndex: number,
                        endIndex: number,
