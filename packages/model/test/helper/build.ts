...
import type {NodeType} from '@src/schema/NodeType';
import type {MarkType} from '@src/schema/MarkType';
...
type NodeBuilderType = ((attrsOrFirstChild?: Attrs | ChildSpec, ...children: ChildSpec[]) => Node & { tag: Tags; }) & {
    flat?: readonly Node[];
};

const noTag = Object.create(null);
...
export function builders<Nodes extends string = any, Marks extends string = any>(schema: Schema<Nodes, Marks>, names?: {
    [name: string]: Attrs;
}) {
    let result = {schema};
