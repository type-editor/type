...
import {br, doc, eq, h1, hr, img, p, pre, schema} from './helper';
import ist from 'ist';
import type {Node} from '@src/elements/Node';
import {ContentParser} from '@src/content-parser/ContentParser';

function get(expr: string) { return ContentParser.parse(expr, schema.nodes); }
...
describe("ContentMatch", () => {
    ...
    describe("fillBefore", () => {
        it("returns the empty selfPos when things match", () =>
