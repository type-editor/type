...
import type { Command, Selection } from '@type-editor/state';
import { EditorState, NodeSelection } from '@type-editor/state';
...
import {addColumnBefore} from "@src/commands/add-column-before";
import {addColumnAfter} from "@src/commands/add-column-after";
import {addRowAfter} from "@src/commands/add-row-after";
import {addRowBefore} from "@src/commands/add-row-before";
...
describe('CellSelection', () => {
  ...
  function run(anchor: number, head: number, command: Command): PmEditorState {
