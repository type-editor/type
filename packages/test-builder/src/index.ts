...
import {builders, type MarkBuilder, type NodeBuilder} from './build';
import {schema as bSchema} from './schema/schema-basic';
import {addListNodes} from './schema/util';

export {builders, type FlattenedNodes, type MarkBuilder, type NodeBuilder} from './build';
export * as bSchema from './schema/prosemirror-schema-basic';
...
export {setupJSDOMMocks} from './setup-jsdom-mocks';
